...
export class MemberService {
  ...
  getMembers(page: number = 0, size: number = 10, search?: string): Observable<ApiResponse<any>> {
  ...
  getMemberById(id: string): Observable<ApiResponse<MemberDetails>> {
    return this.http.get<ApiResponse<MemberDetails>>(`${this.API_URL}/${id}`);
  }
