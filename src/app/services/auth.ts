...
import { Admin, LoginRequest, LoginResponse,ApiResponse } from '../models/admin';
...
export class AuthService {
  ...
  login(credentials: LoginRequest): Observable<ApiResponse<Admin>> {
    ...
    return this.http.post<ApiResponse<Admin>>(`${this.API_URL}/admin/login`, credentials)
      .pipe(
  ...
  private handleLoginSuccess(response: ApiResponse<Admin>): void {
